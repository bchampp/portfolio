#ifndef __BINTREE_FUNCTION_HEADER
#define __BINTREE_FUNCTION_HEADER 
...
//new functions added for lab 7 
void bintree_print_breadth_frist(BinaryTree*);
